...
const List<PashaStyleV173> pashaStylesV173 = <PashaStyleV173>[
  ...
  PashaStyleV173('black', 'أسود', 'Black', '#15151c', '#000000', 'assets/images/pasha/v173/pasha_black.png'),
...
List<StoreProduct> buildV173StoreProducts() => <StoreProduct>[
    ...
    StoreProduct(id: 'pasha_style_black_v173', category: 'pasha_style', icon: '👑', nameAr: 'طربوش باشا أسود', nameEn: 'Black Pasha Fez', descriptionAr: 'هوية باشا كاملة باللون أسود: الطربوش والوهج والاسم والدردشة واللون الرئيسي.', descriptionEn: 'Full black Pasha identity: fez, glow, name, chat and accent color.', price: 6500, value: 'black', previewColor1: Color(0xff15151c), previewColor2: Color(0xff000000), imageAsset: 'assets/images/pasha/v173/pasha_black.png', collection: 'pasha_v173'),
...
class PashaHatV173 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Image.asset('assets/images/pasha.png', width: width, height: height ?? width * .68, fit: BoxFit.contain, filterQuality: FilterQuality.high, errorBuilder: (_, __, ___) => const Icon(Icons.workspace_premium, color: Colors.redAccent));
  }
}
