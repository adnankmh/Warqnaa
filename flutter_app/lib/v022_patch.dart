...
Future<void> showLeaderboardV022(BuildContext context, AppController controller) async {
  final entries = <LocalFriend>[
    LocalFriend(6, 'ياسر', 'Yasser', online: true, activity: 'المركز الأول', level: 64, xp: 18420, xpNext: xpNeededForLevelPatchV025(64), gamesPlayed: 1870, wins: 1210, badge: 'LEGEND'),
    LocalFriend(3, 'ليلى', 'Layla', online: true, activity: 'المركز الثاني', level: 61, xp: 17980, xpNext: xpNeededForLevelPatchV025(61), gamesPlayed: 1640, wins: 1044, badge: 'PRO'),
    LocalFriend(2, 'سامر', 'Samer', online: true, activity: 'المركز الثالث', level: 58, xp: 16800, xpNext: xpNeededForLevelPatchV025(58), gamesPlayed: 1530, wins: 930, badge: 'PRO'),
    LocalFriend(9, 'أحمد', 'Ahmad', online: false, activity: 'المركز الرابع', level: 55, xp: 15120, xpNext: xpNeededForLevelPatchV025(55), gamesPlayed: 1420, wins: 810),
  ];
  await showPremiumSheet(
    context,
