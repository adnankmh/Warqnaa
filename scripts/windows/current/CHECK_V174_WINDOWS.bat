...
echo [7/10] Testing v173 online engagement contract...
python tools\test_v173_online_engagement_contract.py || goto :fail
echo [8/10] Testing v174 direct invite, orientation and XP...
python tools\test_v174_direct_invite_xp_contract.py || goto :fail
