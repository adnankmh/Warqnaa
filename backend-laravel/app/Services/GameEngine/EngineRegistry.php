...
final class EngineRegistry
{
    ...
    public static function all(): array
    {
        return [
            ...
            'saudi_hand' => self::entry('هاند سعودي','Saudi Hand','global_saudi_hand_final_v1',2,4,false,14,106,['draw_deck','draw_discard','meld','discard'],
            ...
            'banakil' => self::entry('بناكل','Banakil','global_banakil_final_v1',2,4,true,14,106,['draw_deck','draw_discard','meld','discard'],
