...
{
    public function test_normalizer_accepts_many_correct_card_formats(): void
    {
    ...
    public function test_tarneeb_does_not_reject_correct_card_format(): void
    {
    ...
    public function test_tarneeb_follow_suit_is_still_enforced(): void
    {
        $engine=new TarneebRules();
        $state=[
            'phase'=>'playing',
