...
Route::middleware('auth')->group(function(){
 ...
 Route::get('/clubs',[ClubController::class,'index'])->name('clubs'); Route::post('/clubs',[ClubController::class,'store'])->name('clubs.store'); Route::get('/clubs/{club}',[ClubController::class,'show'])->name('clubs.show'); Route::post('/clubs/{club}/join',[ClubController::class,'requestJoin'])->name('clubs.join'); Route::post('/clubs/{club}/leave',[ClubController::class,'leave'])->name('clubs.leave'); Route::post('/clubs/{club}/delete',[ClubController::class,'delete'])->name('clubs.delete'); Route::post('/clubs/{club}/member/{member}',[ClubController::class,'memberAction'])->name('clubs.memberAction'); Route::post('/club-requests/{request}/respond',[ClubController::class,'respond'])->name('clubs.respond');
