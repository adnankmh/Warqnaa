...
def main() -> None:
    ...
    if meta.get('version')!='0.3.0' or meta.get('build')!=180 or meta.get('display_release')!='V0.3':
        fail('Release metadata is not Warqnaa V0.3 build 180')
    req('flutter_app/pubspec.yaml','version: 0.3.0+180')
